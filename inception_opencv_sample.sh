...
model_file=$models_dir/$model_name.pb

# ==========
# commands with options 
# ==========
#cmd="$install_dir/yolo_object_detection -video=0 -cfg=$models_dir/$model_name.cfg -model=$models_dir/$model.weights -class_names=$label_path -scale_factor=$scale_factor -input_size=$model_input_size"
cmd="$install_dir/tf_inception 
    -image=$input_path -model=$model_file 
